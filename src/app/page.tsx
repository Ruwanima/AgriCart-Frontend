      ...
      <section id="features" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-black mb-6">Why Choose AgriCart?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">Experience the future of local agricultural commerce with our innovative platform</p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => {
              const IconComponent = (iconMap as any)[feature.icon]
              return (
      ...
      <section className="py-20 bg-gradient-to-br from-black to-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">Simple steps to connect with fresh, local agricultural products</p>
          </div>
